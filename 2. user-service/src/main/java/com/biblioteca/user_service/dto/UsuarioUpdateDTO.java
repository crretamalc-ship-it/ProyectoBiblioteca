...
/**
 * DTO de entrada para actualizar parcialmente un usuario (PUT /api/users/{id}).
 * Todos los campos son opcionales pero, si vienen, se validan.
 */
@Data
...
public class UsuarioUpdateDTO {
    ...
    @Schema(description = "Password del usuario", example = "nuevoSecreto123")
